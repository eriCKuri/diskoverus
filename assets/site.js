...
(function(){
  ...
  var PLACE_SLUGS = ["argentina","australia","austria","belgium","botswana","brazil","cambodia","canada","chile","china","colombia","costa-rica","croatia","cuba","czechia","denmark","ecuador","egypt","fiji","finland","france","germany","ghana","greece","hungary","iceland","india","indonesia","ireland","israel","italy","jamaica","japan","jordan","kenya","madagascar","malaysia","maldives","mexico","mongolia","morocco","nepal","netherlands","new-zealand","norway","panama","peru","philippines","poland","portugal","qatar","rwanda","singapore","south-africa","south-korea","spain","sri-lanka","sweden","switzerland","tanzania","thailand","turkey","united-arab-emirates","united-kingdom","united-states-of-america","vietnam"];
