...
(function(){
  ...
  var PLACE_SLUGS = ["albania","andorra","antigua-and-barbuda","argentina","armenia","australia","austria","azerbaijan","bahamas","bahrain","bangladesh","barbados","belgium","belize","bhutan","bolivia","bosnia-and-herzegovina","botswana","brazil","bulgaria","cabo-verde","cambodia","canada","chile","china","colombia","costa-rica","croatia","cuba","cyprus","czechia","denmark","dominica","dominican-republic","ecuador","egypt","el-salvador","estonia","ethiopia","fiji","finland","france","georgia","germany","ghana","greece","grenada","guatemala","guyana","holy-see-vatican-city","honduras","hungary","iceland","india","indonesia","ireland","israel","italy","ivory-coast","jamaica","japan","jordan","kazakhstan","kenya","kuwait","kyrgyzstan","laos","latvia","lebanon","liechtenstein","lithuania","luxembourg","madagascar","malaysia","maldives","malta","mauritius","mexico","moldova","monaco","mongolia","montenegro","morocco","namibia","nepal","netherlands","new-zealand","nicaragua","north-macedonia","norway","oman","panama","paraguay","peru","philippines","poland","portugal","qatar","romania","rwanda","saint-kitts-and-nevis","saint-lucia","saint-vincent-and-the-grenadines","san-marino","saudi-arabia","senegal","serbia","seychelles","singapore","slovakia","slovenia","south-africa","south-korea","spain","sri-lanka","suriname","sweden","switzerland","tajikistan","tanzania","thailand","trinidad-and-tobago","tunisia","turkey","uganda","united-arab-emirates","united-kingdom","united-states-of-america","uruguay","uzbekistan","vietnam","zambia","zimbabwe"];
